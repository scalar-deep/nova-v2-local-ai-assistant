...
class Config:
    ...
    project_root: str = "/home/pi/Nova_OpenWakeModel"
    assets_path: str = "/home/pi/Nova_OpenWakeModel/assets/face"

    # Audio - Piper TTS (using piper-tts Python package)
    piper_voice: str = "/home/pi/Nova_OpenWakeModel/piper/voices/en_GB-semaine-medium.onnx"

    # Whisper.cpp
    whisper_path: str = "/usr/local/bin/whisper-cpp"
    whisper_model: str = "/home/pi/Nova_OpenWakeModel/whisper.cpp/models/ggml-base.en.bin"

    # Models
    chat_model: str = "qwen2.5:1.5b"

    # Wake word
    wake_word_model: str = "/home/pi/Nova_OpenWakeModel/models/wake_word/hey_jarvis_v0.1.onnx"
    ...
    local_soul_path: str = "/home/pi/Nova_OpenWakeModel/config/local_soul.md"
    cloud_soul_path: str = "/home/pi/Nova_OpenWakeModel/config/cloud_soul.md"
